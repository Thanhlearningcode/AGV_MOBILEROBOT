...
const double TICKS_PER_REVOLUTION = 850; // For reference purposes.    // 620  // 1545
...
const double TICKS_PER_METER = 4100; // Original was 2800
...
void publish_quat() {
  ...
  quatOdom.header.frame_id = "odom_origin";
  //quatOdom.child_frame_id = "base_link";
  quatOdom.child_frame_id = "wheelodom";          // Archie fix 7/1/2023 base_footprint
