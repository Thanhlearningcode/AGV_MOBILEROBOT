...
switch (motor2->timerChannel) {
    case 1:
        motor2->timer->CCMR1 &= ~ (3U << 0);  // CC1 channel is output
        motor2->timer->CCMR1 |=   (6U << 4);   // PWM mode 1 for CC1
        motor2->timer->CCER  |=   (1U << 0);    // Enable output for Channel 1 of motor2
        break;
    case 2:
        ...
        break;
    case 3:
        motor2->timer->CCMR2 &= ~ (3U << 0);  // CC3 channel is output
        motor2->timer->CCMR2 |=   (6U << 4);   // PWM mode 1 for CC3
        motor2->timer->CCER  |=   (1U << 8);    // Enable output for Channel 3 of motor2
        break;
    default:
        motor2->timer->CCMR2 &= ~ (3U << 8);  // CC4 channel is output
        motor2->timer->CCMR2 |=   (6U << 12);  // PWM mode 1 for CC4
        motor2->timer->CCER  |=   (1U << 12);   // Enable output for Channel 4 of motor2
        break;
}
...
/**************************************************************************************************
 *  STATIC INLINE FUNCTIONS TO CHECK VALUES OF INPUT PWM
 **************************************************************************************************/
