...
if("TRUE" STREQUAL "TRUE")
  set(wheel_odom_SOURCE_PREFIX /home/thanh/catkin_ws/src/wheel_odom)
  set(wheel_odom_DEVEL_PREFIX /home/thanh/catkin_ws/devel/.private/wheel_odom)
  ...
  set(wheel_odom_INSTALL_PREFIX /home/thanh/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'archiep <archiep@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'wheel_odom' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'wheel_odom' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/thanh/catkin_ws/src/wheel_odom/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT wheel_odom_NUM_DUMMY_TARGETS)
      set(wheel_odom_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::wheel_odom::wrapped-linker-option${wheel_odom_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR wheel_odom_NUM_DUMMY_TARGETS "${wheel_odom_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::wheel_odom::wrapped-linker-option${wheel_odom_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND wheel_odom_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/thanh/catkin_ws/devel/.private/wheel_odom/lib;/home/thanh/catkin_ws/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${wheel_odom_dep}_FOUND)
      find_package(${wheel_odom_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${wheel_odom_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(wheel_odom_EXPORTED_TARGETS ${${wheel_odom_dep}_EXPORTED_TARGETS})
endforeach()
